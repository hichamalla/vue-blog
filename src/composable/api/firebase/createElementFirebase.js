...
const createNewDoc = (docData, collectionName) => {
...
const getdocsFirebase = (collectionName) => {
...
const fetchDoc = (collectionName,id) => {
...
export  {createNewDoc,getdocsFirebase,fetchDoc};